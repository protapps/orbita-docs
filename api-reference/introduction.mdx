...
Inicializa um novo pagamento. API_KEY gerada dentro da plataforma em [https://app.orbitapay.com.br/apps](https://app.orbitapay.com.br/appss)

### **GET** `/pay/payments/{transactionId}`

Consulta os detalhes de um pagamento existente pelo ID da transação.
...
- **GET** `/pay/payments/{transactionId}` para consultar status e detalhes
- Retorna informações completas: status, cliente, produtos, dados de pagamento e timestamps
...
Todos os tokens de autenticação são gerados na plataforma em [https://app.orbitapay.com.br/apps](https://app-v2.orbitapay.com.br/apps)